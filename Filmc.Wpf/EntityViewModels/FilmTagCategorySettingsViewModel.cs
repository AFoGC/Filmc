...
{
    public class FilmTagCategorySettingsViewModel : BaseViewModel
    {
        private readonly FilmTagCategory _model;
        private SolidColorBrush _brush;

        public FilmTagCategorySettingsViewModel(FilmTagCategory model)
        {
            _model = model;
        ...
        public FilmTagCategory Model => _model;
